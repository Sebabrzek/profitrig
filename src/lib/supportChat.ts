...
5. **Profile** (free) — name, phone, domicile, company; **How you get paid** (switch on "I'm leased to a carrier" and enter the % the carrier keeps, or leave it off to keep 100% as an independent); feedback form; subscription management (upgrade, manage billing).
